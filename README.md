...
Развернули и настроили в k8s прометеус и графану
Настроили источники, посмотрели разные дашборды, проверили мониторинг приложения
Развернули ELK, проверили, что он работает
